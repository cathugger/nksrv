...
SELECT
	last_newnews
FROM
	ib.puller_last_newnews
WHERE
	sid = $1

-- :name puller_set_last_newnews
INSERT INTO
	ib.puller_last_newnews AS ln (sid,last_newnews)
VALUES
	($1,$2)
ON CONFLICT
	(sid)
...
SELECT
	last_newgroups
FROM
	ib.puller_last_newgroups
WHERE
	sid = $1

-- :name puller_set_last_newsgroups
INSERT INTO
	ib.puller_last_newgroups AS ln (sid,last_newgroups)
VALUES
	($1,$2)
ON CONFLICT
	(sid)
