-- :name init_triggers_modlist



-- :next
CREATE FUNCTION ib0.modlist_gc() RETURNS TRIGGER
AS $$
DECLARE
	m_hasrefs BOOLEAN;
BEGIN
...
EXECUTE PROCEDURE ib0.modlist_gc();



-- :next
CREATE FUNCTION ib0.modlist_changepriv() RETURNS TRIGGER
AS $$
BEGIN
